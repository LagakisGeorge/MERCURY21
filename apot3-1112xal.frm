...
Begin VB.Form apot3param 
   ...
   Begin TabDlg.SSTab SSTTab0 
      ...
      TabHeight       =   520
      TabCaption(0)   =   "Tab 0"
      TabPicture(0)   =   "apot3-1112.frx":0000
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "FieldNames"
      Tab(0).Control(1)=   "chkAA"
      Tab(0).Control(2)=   "Text2"
      Tab(0).ControlCount=   3
      TabCaption(1)   =   "Tab 1"
      TabPicture(1)   =   "apot3-1112.frx":001C
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "Parastatika"
      Tab(1).Control(1)=   "txt"
      Tab(1).Control(2)=   "chkΕίδηΣε"
      Tab(1).Control(3)=   "ComORDERCOMBO"
      Tab(1).Control(4)=   "cmdΚριτήριαΕπιλογής"
      Tab(1).Control(5)=   "cmdΦίλτραΠελατών"
      Tab(1).Control(6)=   "apo"
      Tab(1).Control(7)=   "eos"
      Tab(1).Control(8)=   "lblΕως"
      Tab(1).Control(9)=   "lblΑπό"
      Tab(1).ControlCount=   10
      TabCaption(2)   =   "Tab 2"
      TabPicture(2)   =   "apot3-1112.frx":0038
      Tab(2).ControlEnabled=   -1  'True
      Tab(2).Control(0)=   "lblTαξινόμησηΚατά"
      Tab(2).Control(0).Enabled=   0   'False
      Tab(2).Control(1)=   "Combo2"
      Tab(2).Control(1).Enabled=   0   'False
      Tab(2).Control(2)=   "chkΧρησιμοποιώΤο"
      Tab(2).Control(2).Enabled=   0   'False
      Tab(2).Control(3)=   "Text4"
      Tab(2).Control(3).Enabled=   0   'False
      Tab(2).Control(4)=   "File1"
      Tab(2).Control(4).Enabled=   0   'False
      Tab(2).Control(5)=   "cmdΑποθήκευσηReport"
      Tab(2).Control(5).Enabled=   0   'False
      Tab(2).ControlCount=   6
      Begin VB.CommandButton cmdΑποθήκευσηReport 
      ...
      Begin VB.TextBox Text4 
         ...
         Width           =   3705
      End
      Begin VB.CheckBox chkΧρησιμοποιώΤο 
      ...
      Begin VB.ComboBox Combo2 
         Height          =   315
         ItemData        =   "apot3-1112.frx":0054
         Left            =   240
         List            =   "apot3-1112.frx":006D
      ...
      Begin VB.ListBox Parastatika 
         Height          =   840
         ItemData        =   "apot3-1112.frx":00F7
         Left            =   -74280
         List            =   "apot3-1112.frx":00F9
      ...
      Begin VB.CheckBox chkΕίδηΣε 
         ...
         Width           =   2775
      End
      Begin VB.ComboBox ComORDERCOMBO 
         Height          =   315
         ItemData        =   "apot3-1112.frx":00FB
         Left            =   -71400
         List            =   "apot3-1112.frx":0108
         Style           =   2  'Dropdown List
         TabIndex        =   15
         Top             =   1440
         Width           =   1335
      End
      Begin VB.CommandButton cmdΚριτήριαΕπιλογής 
         BackColor       =   &H00FFFF00&
         ...
         Width           =   4215
      End
      Begin VB.CommandButton cmdΦίλτραΠελατών 
         BackColor       =   &H00FFFF80&
         Caption         =   "Φίλτρα Πελατών"
         Height          =   360
         Left            =   -74280
         Style           =   1  'Graphical
         TabIndex        =   13
      ...
      Begin VB.ListBox FieldNames 
         ...
         EndProperty
         Height          =   3210
         ItemData        =   "apot3-1112.frx":0134
         Left            =   -72120
         List            =   "apot3-1112.frx":0136
         MultiSelect     =   1  'Simple
         TabIndex        =   12
         Top             =   600
         Width           =   7410
      ...
      Begin MSComCtl2.DTPicker eos 
         ...
         CurrentDate     =   38814
      End
      Begin VB.Label lblTαξινόμησηΚατά 
         AutoSize        =   -1  'True
         BackStyle       =   0  'Transparent
         Caption         =   "Tαξινόμηση κατά"
         Height          =   195
         Left            =   5280
         TabIndex        =   24
         Top             =   3240
...
550         a = a + " FROM EGGTIM WHERE " + query_pelaton
            a = a + " (NOT APOT IS NULL) AND (NOT EKPT IS NULL) AND (NOT XRE IS NULL) AND (NOT PIS IS NULL) AND (NOT TIMM IS NULL) AND "
