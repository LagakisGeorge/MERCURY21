...
Public Sub ResizeFormFor(ByRef FormToResize As Form)
    ...
    If Not BArx Then
        ...
        For Each FormControl In FormToResize
          'Debug.Print FormControl.Name
        ' If FormControl.Name = "TDBGrid1" Then
           '  Debug.Print "==============================================="
           ' Debug.Print FormControl.Left
            'Debug.Print FormControl.Top
        ...
        If FormToResize.Width > 20000 Then

            FormToResize.BackColor = &HFF0000
            FormToResize.Picture = LoadPicture()
        Else

            FormToResize.Picture = LoadPicture(gPicture)
        End If
...
Private Sub ResizeControl(ByRef FResize As Control, ByRef FormToResize As Form)
    ...
    If FResize.Left < 0 Then
        ...
        ' lLeft = CLng(((CMobj(i).Left * xRatio)) - 75000)
    Else
    ...
    If TypeOf FResize Is CommandButton Or TypeOf FResize Is TextBox Then
...
'lHeight = lHeight * 1.2
    ...
    Else
        ...
        If TypeOf FResize Is Label Or TypeOf FResize Is CommandButton Or TypeOf FResize Is OptionButton Or TypeOf FResize Is CheckBox Or TypeOf FResize Is Frame Or TypeOf FResize Is TextBox Or TypeOf FResize Is ComboBox Or TypeOf FResize Is DriveListBox Then FResize.Font.Size = lFontSize
