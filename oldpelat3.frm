...
Begin VB.Form pelat3 
   ...
   Begin TrueOleDBGrid80.TDBGrid TDBGrid 
      ...
      Splits(0).DividerColor=   15591915
      ...
      CellTipsWidth   =   0
      DataView        =   2
      DeadAreaBackColor=   15591915
      RowDividerColor =   15591915
      RowSubDividerColor=   15591915
...
Dim f_PALIAXRONIA    ' = Trim(FindParametroi("PAR1", "F_PALIAXRONIA", "2005", "Γ.18 DSN ΠΑΛΙΑΣ ΧΡΟΝΙΑΣ"))
...
100     If Combo1.Text = Combo1.List(0) Then mBUFF = "e" Else mBUFF = "r"
...
170     Gdb.Execute "UPDATE PEL  SET TYP=AYP WHERE EIDOS='" + mBUFF + "'"
        ...
        'pelates
180     If Combo1.Text = Combo1.List(0) Then    '  "e",
...
210     X = "select '@@@' AS [Α_Α],KOD AS [Κωδ],LEFT(EPO,25) as [Επωνυμία]"
...
320             F_mWidth(mc) = f_list1(temp, 3)
        ...
        'TDBGrid1.Columns(1).ValueItems.Presentation = dbgCheckBox
...
350         X = X + " from PEL where  KOD NOT LIKE '997%'  AND KOD NOT LIKE '998%'  AND EIDOS='" + IIf(Combo1.Text = Combo1.List(0), "e", "r") + "'"
        Else
360         X = X + " from PEL where PEL.KOD NOT IN (SELECT LTRIM(STR(TIMH)) FROM PINAKES WHERE (NOT TIMH IS NULL) AND  TYPOS=12) AND EIDOS='" + IIf(Combo1.Text = Combo1.List(0), "e", "r") + "'"
        End If
...
240             TDBGrid.Splits(0).Columns(k).FooterText = Format(SYNOLA(k), "######0.00")
                TDBGrid.Splits(0).Columns(k).FooterFont.Size = 14 ' = Format(SYNOLA(k), "######0.00")
            End If
...
220     If Combo1.Text = Combo1.List(0) Then mBUFF = "e" Else mBUFF = "r"
230     F_RUN = 1
...
260     dum2 = ADD_FIELD("PEL", "NUM5", "DECIMAL")
270     dum2 = ADD_FIELD("PEL", "NUM6", "DECIMAL")
280     dum2 = ADD_FIELD("PEL", "NUM7", "DECIMAL")
290     dum2 = ADD_FIELD("PEL", "NUM8", "DECIMAL")
...
360     X = X + "ROUND(NUM8,2) AS [0-30],ROUND(NUM4,2) AS [30-60],ROUND(NUM5,2) AS [60-90],ROUND(NUM6,2) AS [90-120],ROUND(NUM7,2) AS [120-],ROUND(TYP,2) AS [ΥΠΟΛΟΙΠΟ] "
...
490         X = X + " from PEL where TYP>0 and KOD NOT LIKE '997%'  AND KOD NOT LIKE '998%'  AND EIDOS='" + IIf(Combo1.Text = Combo1.List(0), "e", "r") + "'"
        Else
500         X = X + " from PEL where TYP>0 AND  EIDOS='" + IIf(Combo1.Text = Combo1.List(0), "e", "r") + "'"
        End If
...
1330        PELA = PELA + "     AΠΟ " + Format(apo, "DD/MM/YYYY") + " ΕΩΣ " + Format(eos, "DD/MM/YYYY")
            ...
            On Error GoTo Command3_Click_Err    ' Resume Next
...
150     If Combo1.Text = Combo1.List(0) Then X2 = "e" Else X2 = "r"
...
180     f_PALIAXRONIA = Trim(FINDPARAMETROI("PAR1", "F_PALIAXRONIA", "2005", "Γ.18 DSN ΠΑΛΙΑΣ ΧΡΟΝΙΑΣ"))
        ...
        F_PLATOS_FORMAS = FINDPARAMETROI("PELAT3", "F_PLATOS_FORMAS", "15625", "Πλάτος φόρμας")
...
190     F_LHM1 = FINDPARAMETROI("PELAT2", "F_lhm1", "Ημερ1", "Ετικέτα ημερ.1")
200     F_LHM2 = FINDPARAMETROI("PELAT2", "F_lhm2", "Ημερ2", "Ετικέτα ημερ.2")
210     f_lHM3 = FINDPARAMETROI("PELAT2", "F_lhm3", "Ημερ3", "Ετικέτα ημερ.3")
220     f_lHM4 = FINDPARAMETROI("PELAT2", "F_lhm4", "Ημερ4", "Ετικέτα ημερ.4")
230     f_lHM5 = FINDPARAMETROI("PELAT2", "F_lhm5", "Ημερ5", "Ετικέτα ημερ.5")
240     f_lHM6 = FINDPARAMETROI("PELAT2", "F_lhm6", "Ημερ6", "Ετικέτα ημερ.6")

250     f_lab1 = FINDPARAMETROI("PELAT2", "F_lab1", "Κειμ1", "Ετικέτα κειμ.1")
260     f_lab2 = FINDPARAMETROI("PELAT2", "F_lab2", "Κειμ2", "Ετικέτα κειμ.2")
270     f_lab3 = FINDPARAMETROI("PELAT2", "F_lab3", "Κειμ3", "Ετικέτα κειμ.3")
280     f_lab4 = FINDPARAMETROI("PELAT2", "F_lab4", "Κειμ4", "Ετικέτα κειμ.4")
290     f_lab5 = FINDPARAMETROI("PELAT2", "F_lab5", "Κειμ5", "Ετικέτα κειμ.5")
300     f_lab6 = FINDPARAMETROI("PELAT2", "F_lab6", "Κειμ6", "Ετικέτα κειμ.6")

310     f_num1 = FINDPARAMETROI("PELAT2", "F_num1", "Αριθ1", "Ετικέτα κειμ.1")
320     f_num2 = FINDPARAMETROI("PELAT2", "F_num2", "Αριθ2", "Ετικέτα κειμ.2")
330     f_num3 = FINDPARAMETROI("PELAT2", "F_num3", "Αριθ3", "Ετικέτα κειμ.3")
340     f_num4 = FINDPARAMETROI("PELAT2", "F_num4", "Αριθ4", "Ετικέτα κειμ.4")
...
700             List1.AddItem f_list1(k, 4) + Space(80) + Format(k, "00")
            End If
...
100     pelat4.PELPROM.ListIndex = IIf(Left(Combo1.Text, 1) = "e", 0, 1)    ' Option1(1).value
110     pelat4.SHOW
...
100     DD = IIf(Left(Combo1.Text, 1) = "e", 0, 1)

110     fff.PELPROM.ListIndex = DD

120     TDBGrid.Col = 1
130     fff.ffbuff = Left(Combo1.Text, 1) + TDBGrid.Text  ' Data1.Recordset("kod") ' Text1(0).Text
