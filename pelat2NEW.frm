...
Begin VB.Form pelat2 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin TabDlg.SSTab SSTab1 
         ...
         TabCaption(4)   =   "ΟΙΚΟΝΟΜΙΚΑ ΣΤΟΙΧΕΙΑ"
         ...
         Begin VB.Label Label6 
            AutoSize        =   -1  'True
            BackStyle       =   0  'Transparent
            Caption         =   "ΑΔΑ/ΕΝΑΡΙΘΜΟΣ ΣΥΜΒΑΣΗΣ"
            Height          =   195
            Left            =   1800
            TabIndex        =   137
            Top             =   3000
         ...
         Begin VB.Label Label5 
            AutoSize        =   -1  'True
            BackStyle       =   0  'Transparent
            Caption         =   "ΤΥΠΟΣ ΠΡΟΥΠΟΛΟΓΙΣΜΟΥ1-3"
            Height          =   195
            Left            =   1800
            TabIndex        =   136
            Top             =   2160
...
Dim f_printer
Dim F_FORMAT_PEL_KOD      As String  '= FINDPARAMETROI(1, "PELAT1", "F_FORMAT_PEL_KOD", "0000", "ΨΗΦΙΑ ΚΩΔΙΚΟΥ ΠΕΛΑΤΩΝ")
...
Dim F_MONOENERGOS As Integer '= Val(FINDPARAMETROI(1, "PAR1", "F_MONOENERGOS", "0", "ΔΕΙΧΝΕΙ ΜΟΝΟ ΤΟΥΣ ΕΝΕΡΓΟΥΣ=1 ΟΛΟΥΣ=0")) '
...
'Dim ANS As Integer: ANS = MsgBox("Να σωθούν οι αλλαγές;", vbYesNo)
'If ANS = vbYes Then
...
100    ' If cmdDiortosi.Caption = "Διόρθωση" Then
'110         cmdDiortosi.Caption = "Ενημέρωση"
'
'120         For k = 1 To 15
'130             Text1(k).Enabled = True
'140             Text1(k).ForeColor = vbBlack
...
'180         cmdNew.Enabled = True
       ' Else
190      '   cmdDiortosi.Caption = "Διόρθωση"
...
' τα παρακατω είναι από την τιμολόγηση
...
180   '  cmdDiortosi.Caption = "Διόρθωση"
        'Command3_Click
...
'για να βαλει κατα φθίνουσα ημερομηνια
   Listview1.SortKey = 1
...
'Dim f_LabAFM                 As String
     ...
     F_FORMAT_PEL_KOD = FINDPARAMETROI(1, "PELAT1", "F_FORMAT_PEL_KOD", "0000", "ΨΗΦΙΑ ΚΩΔΙΚΟΥ ΠΕΛΑΤΩΝ")
...
222
        ...
        F_CAN_SYGXONEYSI = Val(FINDPARAMETROI(1, "PELAT2", "F_CAN_SYGXONEYSI", "0", "Δυνατότητα συγχώνευσης κωδικών=1 ΟΧΙ=0"))

        f_KENTRA_ADYNATISMATOS = Val(FINDPARAMETROI(99, "PELAT2", "f_KENTRA_ADYNATISMATOS", "0", "Αν είναι κέντρο αδυνατίσματος=1"))
...
120     Me.KeyPreview = True
        ...
        'f_checkPos = Val(FindParametroi(1,"PAR1", "F_CHECKPOS", "DELETE", "1=ΕΛΕΓΧOΣ 2=ΑΠΑΓΟΡΕΥΣΗ 0=ΤΙΠΟΤΑ"))
...
300     F_LHM1 = FINDPARAMETROI(2, "PELAT2", "F_lhm1", "Ημερ1", "Ετικέτα ημερ.1")
310     F_LHM2 = FINDPARAMETROI(2, "PELAT2", "F_lhm2", "Ημερ2", "Ετικέτα ημερ.2")
320     f_lHM3 = FINDPARAMETROI(2, "PELAT2", "F_lhm3", "Ημερ3", "Ετικέτα ημερ.3")
330     f_lHM4 = FINDPARAMETROI(2, "PELAT2", "F_lhm4", "Ημερ4", "Ετικέτα ημερ.4")
340     f_lHM5 = FINDPARAMETROI(2, "PELAT2", "F_lhm5", "Ημερ5", "Ετικέτα ημερ.5")
350     f_lHM6 = FINDPARAMETROI(2, "PELAT2", "F_lhm6", "Ημερ6", "Ετικέτα ημερ.6")
...
F_LABEL_ADT = FINDPARAMETROI(1, "PELAT2", "F_LABEL_ADT", "ΑΔΤ", "Eτικετα Αριθ.Ταυτότητας  ")

Label1(24).Caption = F_LABEL_ADT

     '   F_TRAINPERIODS = Val(FINDPARAMETROI(1, "PELAT2", "F_TRAINPERIODS", "0", "1=ΦΡΟΝΤΙΣΤΗΡΙΑ ΜΕ ΠΕΡΙΟΔΟΥΣ 0=ΟΧΙ  "))
...
440     f_lab1 = FINDPARAMETROI(3, "PELAT2", "F_lab1", "Κειμ1", "Ετικέτα κειμ.1")
450     f_lab2 = FINDPARAMETROI(3, "PELAT2", "F_lab2", "Κειμ2", "Ετικέτα κειμ.2")
460     f_lab3 = FINDPARAMETROI(3, "PELAT2", "F_lab3", "Κειμ3", "Ετικέτα κειμ.3")
470     f_lab4 = FINDPARAMETROI(3, "PELAT2", "F_lab4", "Κειμ4", "Ετικέτα κειμ.4")
480     f_lab5 = FINDPARAMETROI(3, "PELAT2", "F_lab5", "Κειμ5", "Ετικέτα κειμ.5")
490     f_lab6 = FINDPARAMETROI(3, "PELAT2", "F_lab6", "Κειμ6", "Ετικέτα κειμ.6")

492     f_lab7 = FINDPARAMETROI(3, "PELAT2", "F_lab7", "Κειμ7", "Ετικέτα κειμ.7")
...
560     f_num1 = FINDPARAMETROI(4, "PELAT2", "F_num1", "Αριθ1", "Ετικέτα Αριθμ.1")
570     f_num2 = FINDPARAMETROI(4, "PELAT2", "F_num2", "Αριθ2", "Ετικέτα Αριθμ.2")
580     f_num3 = FINDPARAMETROI(4, "PELAT2", "F_num3", "Αριθ3", "Ετικέτα Αριθμ.3")
590     f_num4 = FINDPARAMETROI(4, "PELAT2", "F_num4", "Αριθ4", "Ετικέτα Αριθμ.4")
...
630     Lnum4.Caption = f_num4
        ...
        f_lbcb1 = FINDPARAMETROI(51, "PELAT2", "f_lbcb1", "Αριθ1", "Πολ.Eτικ 1")
        f_lbcb2 = FINDPARAMETROI(53, "PELAT2", "f_lbcb2", "Αριθ2", "Πολ.Eτικ 2")
        f_lbcb3 = FINDPARAMETROI(55, "PELAT2", "f_lbcb3", "Αριθ3", "Πολ.Eτικ 3")
        f_lbcb4 = FINDPARAMETROI(57, "PELAT2", "f_lbcb4", "Αριθ4", "Πολ.Eτικ 4")
        f_lbcb5 = FINDPARAMETROI(59, "PELAT2", "f_lbcb5", "Αριθ4", "Πολ.Eτικ 5")
        ...
        f_comb1 = FINDPARAMETROI(52, "PELAT2", "f_comb1", "", "Επιλογές π.χ. Εμπορος;Ιδιώτης;Υπάλληλος")
        f_comb2 = FINDPARAMETROI(54, "PELAT2", "f_comb2", "", "Επιλογές π.χ. Εμπορος;Ιδιώτης;Υπάλληλος")
        f_comb3 = FINDPARAMETROI(56, "PELAT2", "f_comb3", "", "Επιλογές π.χ. Εμπορος;Ιδιώτης;Υπάλληλος")
        f_comb4 = FINDPARAMETROI(58, "PELAT2", "f_comb4", "", "Επιλογές π.χ. Εμπορος;Ιδιώτης;Υπάλληλος")
        f_comb5 = FINDPARAMETROI(60, "PELAT2", "f_comb5", "", "Επιλογές π.χ. Εμπορος;Ιδιώτης;Υπάλληλος")
...
670     PROTH = 1
680     Text2(1) = ""    'goo
690    ' cmdDiortosi.Caption = "Διόρθωση"   'ΣΔΦΔΣΦ
...
250             FF = (SameLetters(Text2(1).Text))
            'End If
            If F_MONOENERGOS = 0 Then '  Val(FINDPARAMETROI(1, "PAR1", "F_MONOENERGOS", "0", "ΔΕΙΧΝΕΙ ΜΟΝΟ ΤΟΥΣ ΕΝΕΡΓΟΥΣ=1 ΟΛΟΥΣ=0")) '
...
Select Case Button.key
    Case "cmdNew"
       ...
       Frame2.Visible = False
       Frame1.Top = Toolbar1.Height
       Text1(0).Enabled = True  'ενεργοποιώ τον κωδικό για να μπορεί να τον αλλάξει
 ...
 Case "cmdUpdate"
       ...
       Text1(0).Enabled = False  'απενεργοποιώ τον κωδικό για να μην  μπορεί να τον αλλάξει
