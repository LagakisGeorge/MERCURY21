...
Begin VB.Form par4 
   ...
   Begin TrueOleDBGrid80.TDBGrid DBGrid1 
      ...
      CellTipsWidth   =   0
      DataView        =   2
      GroupByCaption  =   "Κάντε click στον τίτλο στήλης για ταξινόμηση ή Σύρτε τον για ομαδοποίηση"
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "par4.frx":3026
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "par4.frx":3578
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "par4.frx":3ABA
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "par4.frx":3FFC
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "par4.frx":488E
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "par4.frx":4DE0
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "par4.frx":4EF2
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "par4.frx":5444
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "par4.frx":5996
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "par4.frx":5EE8
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "par4.frx":647A
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "par4.frx":6A0C
            Key             =   ""
         EndProperty
      EndProperty
   End
...
1010        MSFlexGrid1.CellBackColor = vbBlue    'vbYellow

1020        If addit2 = 0 Then    ' fetines agores
1030            MSFlexGrid1.CellBackColor = vbBlue    ' vbYellow
            Else
...
140     ANS = MsgBox("ΠΩΛΗΣΕΙΣ=ΝΑΙ  ΟΧΙ=ΑΓΟΡΕΣ", vbYesNo)
...
220         MSYNT = " ascii(LEFT(ATIM,1)) IN (" + pol + "," + polepis + ") AND "
        Else
230         MSYNT = " ascii(LEFT(ATIM,1)) IN (" + pol + polepis + ") AND  APOT=" + str(apot.ListIndex) + " AND "
        End If
...
240     sql = "SELECT left(PARASTAT.EIDOS+' '+PARASTAT.TITLOS+'                     ',25) AS [Παραστατικό]," _
           ...
           & " CONVERT(DECIMAL(10,2),sum(CASE WHEN ascii(LEFT(ATIM,1)) IN (" + pol + ") THEN AJ7 ELSE -(AJ7)  END )) AS [" + Format(g_Fpa(7), "##") + "%], " _
           & " CONVERT(DECIMAL(10,2),sum(CASE WHEN ascii(LEFT(ATIM,1)) IN (" + pol + ") THEN AJ1+AJ2+AJ3+AJ4+AJ5+AJ6+AJ7 ELSE -(AJ1+AJ2+AJ3+AJ4+AJ5+AJ6+AJ7)  END )) AS [ΣΥΝΟΛΟ], " _
           & " CONVERT(DECIMAL(10,2),sum(CASE WHEN ascii(LEFT(ATIM,1)) IN (" + pol + ") THEN KERDOS ELSE 0  END )) AS [ΚΕΡΔΟΣ] " _
...
Private Sub DBGrid1_GroupColMove(ByVal Position As Integer, ByVal ColIndex As Integer, Cancel As Integer)
...
100     For Each Col In DBGrid1.GroupColumns
...
TDBGrid_GroupColMove_Err:
        'MsgBox Err.Description & vbCrLf & _
         ...
         "at line " & Erl, _
         vbExclamation + vbOKOnly, "Application Error"
        SAVE_ERROR Err.Description & " in ADOMERCNEW.par4.TDBGrid_GroupColMove " & "at line " & Erl
...
TDBGrid_HeadClick_Err:
        'MsgBox Err.Description & vbCrLf & _
         ...
         "at line " & Erl, _
         vbExclamation + vbOKOnly, "Application Error"
        SAVE_ERROR Err.Description & " in ADOMERCNEW.PAR4.TDBGrid_HeadClick " & "at line " & Erl
...
180     Me.MousePointer = vbHourglass
190     d = "select LEFT(ATIM,8)+' '+(SELECT top 1 LEFT(TITLOS,15) FROM PARASTAT WHERE ASCII(PARASTAT.EIDOS)=ASCII(LEFT(ATIM,1))),"
        d = d + " CONVERT(CHAR(8),HME,3) as [Ημερ/νία]," & " LEFT(PEL.EPO,25) as [Συναλασσόμενος],"
        d = d + "(CASE WHEN ascii(LEFT(ATIM,1)) IN (" + polepis + "," + AGOEPIS + ") THEN -AJI ELSE ROUND(AJI,2) END) as [Συν.Αξία]," '4
        d = d + " (CASE WHEN ASCII(LEFT(ATIM,1)) IN (" + polepis + "," + AGOEPIS + ") THEN -AJ1 ELSE ROUND(AJ1,2) END) as [Καθ.Αξ." + Format(g_Fpa(1), "##") + "%]," '5
        d = d + "(CASE WHEN ASCII(LEFT(ATIM,1)) IN (" + polepis + "," + AGOEPIS + ") THEN -AJ2 ELSE ROUND(AJ2,2) END) as  [Κ.Αξ." + Format(g_Fpa(2), "##") + "%]," '6
        
        d = d + "(CASE WHEN ASCII(LEFT(ATIM,1)) IN (" + polepis + "," + AGOEPIS + ") THEN -AJ3 ELSE ROUND(AJ3,2) END) as  [Κ.Αξ." + Format(g_Fpa(3), "##") + "%],"  '7
        d = d + "(CASE WHEN ASCII(LEFT(ATIM,1)) IN (" + polepis + "," + AGOEPIS + ") THEN -AJ4 ELSE ROUND(AJ4,2) END) as  [Κ.Αξ." + Format(g_Fpa(4), "##") + "%]," '8
        
        d = d + "(CASE WHEN ASCII(LEFT(ATIM,1)) IN (" + polepis + "," + AGOEPIS + ") THEN -AJ5 ELSE round(AJ5,2) END) as  [Κ.Αξ." + Format(g_Fpa(5), "##") + "%]," '9
        
         d = d + "(CASE WHEN ASCII(LEFT(ATIM,1)) IN (" + polepis + "," + AGOEPIS + ") THEN -AJ6 ELSE round(AJ6,2) END) as  [Κ.Αξ." + Format(g_Fpa(6), "##") + "%]," '10
         
          d = d + "(CASE WHEN ASCII(LEFT(ATIM,1)) IN (" + polepis + "," + AGOEPIS + ") THEN -AJ7 ELSE round(AJ7,2) END) as  [Κ.Αξ." + Format(g_Fpa(7), "##") + "%],"  '11
        ...
        d = d + " (case when left(TRP,1)='1' THEN 0 ELSE AJI end) AS [ΠΙΣΤΩΣΗ] " 'into temp" + LTrim(Str(gXEIRISTHS))
