...
Object = "{BD0C1912-66C3-49CC-8B12-7B347BF6C846}#10.1#0"; "CodeJSkinFram.ocx"
Begin VB.Form apot31 
   BackColor       =   &H00FF0000&
   Caption         =   "Form1"
   ClientHeight    =   9555
   ClientLeft      =   60
   ...
   Begin VB.ListBox List1 
      Height          =   1185
      ItemData        =   "apot31.frx":0000
      Left            =   240
      List            =   "apot31.frx":0002
      Style           =   1  'Checkbox
      TabIndex        =   4
      Top             =   360
      Width           =   3015
   ...
   Begin VB.ComboBox Combo2 
      Height          =   315
      ItemData        =   "apot31.frx":0004
      Left            =   240
      List            =   "apot31.frx":001A
      TabIndex        =   0
      Text            =   "Combo2"
      Top             =   0
      Width           =   2655
...
Dim F_ALIG(50), F_mWidth(50), F_sum(50)
...
If Check1 Then
  'typos2
  On Error GoTo 0
  print3_xar UCase(x), SUgm_str, Text2.Text, 0
End If
...
A = A + " FROM EGGTIM WHERE  left(ATIM,1) NOT IN ('σ','Σ')    GROUP BY KODE"
