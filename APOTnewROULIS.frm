...
Begin VB.Form apot2ROULIS 
   ...
   Begin Crystal.CrystalReport CrystalReport1 
      ...
      _ExtentY        =   741
      _Version        =   262150
      ReportFileName  =   "C:\Mercvb\reports\etik.rpt"
      Destination     =   1
   End
   ...
   Begin RichTextLib.RichTextBox Rich1 
      ...
      _Version        =   393217
      Enabled         =   -1  'True
      TextRTF         =   $"APOTnewROULIS.frx":0000
   End
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.ComboBox KATHGORIA 
         Height          =   300
         ItemData        =   "APOTnewROULIS.frx":0086
         Left            =   120
         List            =   "APOTnewROULIS.frx":0088
      ...
      Begin VB.ComboBox ftp 
         Height          =   300
         ItemData        =   "APOTnewROULIS.frx":008A
         Left            =   15240
         List            =   "APOTnewROULIS.frx":0094
         Style           =   2  'Dropdown List
         TabIndex        =   67
         Top             =   8040
         Visible         =   0   'False
