...
' TITLOS_PEDION >=1 stelnei και τις επικεφαλιδες των data
' εφοσον  F_TYPEHEADER=1      = Val(FINDPARAMETROI(1, "EKTYPOTES", "F_TYPEHEADER", "1", "1=ΤΥΠΩΝΟΝΤΑΙ ΕΠΙΚΕΦΑΛΙΔΕΣ ΑΡΧΕΙΟ "))
...
154 If F_TYPEHEADER = 1 Or F_TYPEHEADER = 3 Then '  = Val(FindParametroi(1,"EKTYPOTES", "F_TYPEHEADER", "1", "1=ΤΥΠΩΝΟΝΤΑΙ ΕΠΙΚΕΦΑΛΙΔΕΣ ΑΡΧΕΙΟ "))
